                ...
                datasets: [
                    {
                        ...
                        data: [70, 88, 77, 93, 82, 100, 70, 67,78,99,65,56,88,34],
                        label: 'Dataset',
                        fill: 'false'
                    },
                    {
                        ...
                        data: [80, 88, 67, 95, 76, 60, 67, 95,95,66,65,56,88,34],
                        label: 'Dataset',
                        fill: 'false'
                    },
                    {
                        ...
                        borderColor: 'rgba(69, 39, 160, .7)',
                        data: [60, 88, 70, 67, 27, 83, 78, 88,95,60,65,56,88,34],
                        label: 'Dataset',
                        fill: 'false'
                    },
                    {
                        ...
                        data: [75, 55, 55, 95, 66, 88, 70, 78,77,100,65,56,88,34],
                        label: 'Dataset',
                        fill: 'false'
                    }
                ]
